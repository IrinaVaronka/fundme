...
Route::name('front-')->group(function () {
    ...
    Route::get('/tags-list', [F::class, 'getTagsList'])->name('tags-list')->middleware('role:admin');
    Route::put('/add-tag/{story}', [F::class, 'addTag'])->name('add-tag')->middleware('role:admin');
    Route::post('/add-new-tag/{story}', [F::class, 'addNewTag'])->name('add-new-tag')->middleware('role:admin');
